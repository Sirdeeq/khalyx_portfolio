...
export default function MediaSection() {
  ...
  return (
    <section id="media" className="bg-[#0C0C0C] px-5 sm:px-8 md:px-10 py-20 sm:py-24 md:py-32">
      <FadeIn y={40}>
        <h2
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <FadeIn y={20} delay={0.15}>
          <h3 className="text-2xl sm:text-3xl font-bold text-[#D7E2EA] mb-8 text-center">My Creative Journey</h3>
        </FadeIn>
        ...
        {(media.timeline.length ? media.timeline : [
          ...
          <FadeIn key={item.title} delay={0.1 * i} y={20}>
            ...
            >
              <div className="flex justify-between items-start">
                <div>
                  <div className="flex items-center gap-3 flex-wrap">
                    <h4 className="text-lg sm:text-xl font-bold text-[#D7E2EA]">{item.title}</h4>
                    <span className="text-xs text-[#D7E2EA]/40 border border-white/10 rounded-full px-3 py-0.5">
                      {item.period}
                    </span>
                  </div>
                </div>
                <span
                  className={`text-[#D7E2EA]/40 text-xl ml-4 transition-transform duration-300 flex-shrink-0 ${openIndex === i ? 'rotate-45' : ''}`}
                >
                  +
                </span>
              </div>
              ...
              >
                <p className="text-[#D7E2EA]/70 leading-relaxed border-t border-white/10 pt-4">{item.detail}</p>
              </div>
            </div>
          </FadeIn>
        ))}
      ...
      <div className="max-w-4xl mx-auto mb-20">
        <FadeIn y={20} delay={0.2}>
          <div className="bg-gradient-to-br from-white/[0.03] to-transparent rounded-3xl border border-white/10 p-8 sm:p-10">
            <div className="flex items-center gap-3 mb-4">
              <h3 className="text-2xl sm:text-3xl font-bold text-[#D7E2EA]">Technical Director</h3>
              <span className="text-xs font-medium text-[#D7E2EA]/40 border border-white/10 rounded-full px-3 py-0.5">BMS</span>
            </div>
            <p className="text-[#D7E2EA]/60 mb-6 leading-relaxed">
              I currently serve as the <strong className="text-[#D7E2EA]/80">Technical Director</strong> at <strong className="text-[#D7E2EA]/80">BMS</strong>,
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={j} className="text-[#D7E2EA]/70 leading-relaxed flex items-start gap-2 text-sm">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#D7E2EA]/30 flex-shrink-0 mt-1.5" />
                  {r}
                </li>
              ))}
            </ul>
      ...
      <div className="max-w-5xl mx-auto mb-20">
        <FadeIn y={20} delay={0.25}>
          <h3 className="text-2xl sm:text-3xl font-bold text-[#D7E2EA] mb-8 text-center">Creative Services</h3>
        </FadeIn>
        <div className="flex flex-wrap justify-center gap-3">
          {(media.services.length ? media.services : ['Graphic Design', 'Photography', 'Videography', 'Motion Graphics']).map((s, i) => (
            <FadeIn key={s} delay={0.03 * i} y={15}>
              <span className="inline-block rounded-full border border-[#D7E2EA]/20 text-[#D7E2EA]/70 px-5 py-2 text-sm hover:border-[#D7E2EA]/50 hover:text-[#D7E2EA] transition-all duration-300 cursor-default">
                {s}
              </span>
            </FadeIn>
          ))}
      ...
      <FadeIn y={20} delay={0.3}>
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-2xl sm:text-3xl font-bold text-[#D7E2EA] mb-6">Creative Philosophy</h3>
          <p
            className="text-[#D7E2EA]/70 leading-relaxed"
          ...
          <p className="text-[#D7E2EA]/60 leading-relaxed mt-4">
