...
const defaults: SiteData = {
  ...
  projects: [
    { num: '01', name: 'Paylob', category: 'Fintech', features: 'Secure payments \u2022 Wallet \u2022 Transactions \u2022 Dashboard \u2022 Payment API', impact: 'Built to simplify secure online payments through reliable transaction management and user-friendly financial technology.', role: 'Founder & Lead Developer', url: '', col1_img1: '', col1_img2: '', col2_img: '' },
    { num: '02', name: 'AKY Media Center', category: 'Media & Governance', features: '20 audio tracks \u2022 Live broadcast \u2022 Video streaming \u2022 News portal \u2022 Newsletter \u2022 Social media hub', impact: 'Designed to strengthen media engagement and governance communication through a centralized digital platform for broadcasting, news, and community outreach.', role: 'Lead Developer - Techlife Global Ventures LTD', url: 'https://akywebsite-henna.vercel.app', col1_img1: '', col1_img2: '', col2_img: '' },
    { num: '03', name: 'Elite Edu Tech', category: 'EdTech', features: 'Student dashboard \u2022 Teacher dashboard \u2022 Online learning \u2022 Educational content', impact: 'Created to improve access to education through digital learning tools, student tracking, and interactive educational content delivery.', role: 'Frontend Developer', url: '', col1_img1: '', col1_img2: '', col2_img: '' },
    { num: '04', name: 'GAMSAJ International Ltd', category: 'Construction & Engineering', features: 'Building construction \u2022 Civil engineering \u2022 Real estate \u2022 Project management \u2022 Industrial construction', impact: 'Developed to streamline construction project management and strengthen online presence for an engineering firm serving industrial and residential sectors.', role: 'Lead Developer', url: 'https://gamsaj.com', col1_img1: '', col1_img2: '', col2_img: '' },
  ],
  gallery: [
